...
(function (root, factory) {
  ...
  var DateRangePicker = function (element, options, cb) {
    ...
    this.showadmin_customRangeLabel = true;
    ...
    this.locale = {
      ...
      cancelLabel: "Cancel",
      weekLabel: "W",
      admin_customRangeLabel: "admin_custom Range",
    ...
    //admin_custom options from user
    if (typeof options !== "object" || options === null) options = {};

    //allow setting options with data attributes
    //data-api options will be overwritten with admin_custom javascript options
    ...
    if (typeof options.locale === "object") {
      ...
      if (typeof options.locale.admin_customRangeLabel === "string") {
        //Support unicode chars in the admin_custom range name.
        var elem = document.createElement("textarea");
        elem.innerHTML = options.locale.admin_customRangeLabel;
        var rangeHtml = elem.value;
        this.locale.admin_customRangeLabel = rangeHtml;
      }
    }
    ...
    if (typeof options.showadmin_customRangeLabel === "boolean")
      this.showadmin_customRangeLabel = options.showadmin_customRangeLabel;
    ...
    if (typeof options.isadmin_customDate === "function")
      this.isadmin_customDate = options.isadmin_customDate;
    ...
    if (typeof options.ranges === "object") {
      ...
      if (this.showadmin_customRangeLabel) {
        list +=
          '<li data-range-key="' +
          this.locale.admin_customRangeLabel +
          '">' +
          this.locale.admin_customRangeLabel +
          "</li>";
      }
  ...
  DateRangePicker.prototype = {
    ...
    renderCalendar: function (side) {
      ...
      for (var row = 0; row < 6; row++) {
        ...
        for (var col = 0; col < 7; col++) {
          ...
          //don't allow selection of date if a admin_custom function decides it's invalid
          ...
          //apply admin_custom classes for this date
          var isadmin_custom = this.isadmin_customDate(calendar[row][col]);
          if (isadmin_custom !== false) {
            if (typeof isadmin_custom === "string")
              classes.push(isadmin_custom);
            else Array.prototype.push.apply(classes, isadmin_custom);
          }
    ...
    clickRange: function (e) {
      ...
      if (label == this.locale.admin_customRangeLabel) {
        this.showCalendars();
      } else {
